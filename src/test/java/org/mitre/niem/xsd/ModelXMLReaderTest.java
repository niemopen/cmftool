...
import static org.mitre.niem.xsd.CheckModel.checkClass;
import static org.mitre.niem.xsd.CheckModel.checkCodeListBinding;
import static org.mitre.niem.xsd.CheckModel.checkDatatypes;
import static org.mitre.niem.xsd.CheckModel.checkComponent;
import static org.mitre.niem.xsd.CheckModel.checkDataProperty;
import static org.mitre.niem.xsd.CheckModel.checkLocalTerm;
import static org.mitre.niem.xsd.CheckModel.checkNamespace;
import static org.mitre.niem.xsd.CheckModel.checkObjectProperty;
import static org.mitre.niem.xsd.CheckModel.checkPropAssoc;
...
public class ModelXMLReaderTest {
    ...
    ///////// Tests that share code with ModelFromXSDTest ///////////
    
    @Test
    public void testClass () {
        checkClass(readModel(testDirPath, "class.cmf"));
    }
    
    @Test
    public void testCodeListBinding () {
        checkCodeListBinding(readModel(testDirPath, "codeListBinding.cmf"));
    }
    
    // Test name, namespace, documentation, and deprecated on Components    
    @Test
    public void testComponent () {
        checkComponent(readModel(testDirPath, "component.cmf"));
    }
       
   @Test
   public void testDataProperty () {
       checkDataProperty(readModel(testDirPath, "dataProperty.cmf"));
   }
   ...
   public void testLocalTerm () {
       checkLocalTerm(readModel(testDirPath, "localTerm.cmf"));
   }

   @Test
   public void testNamespace () {
       checkNamespace(readModel(testDirPath, "namespace.cmf"));
   }
   
   @Test
   public void testObjectProperty () {
       checkObjectProperty(readModel(testDirPath, "objectProperty.cmf"));
   }    
   
   @Test
   public void testPropAssoc () {
       checkPropAssoc(readModel(testDirPath, "propAssoc.cmf"));
...
//        assertEquals(1, tpt.propertyList().size());
//        PropertyAssociation h1 = tpt.propertyList().get(0);
...
//        assertEquals(6, ct.propertyList().size());
//        
//        PropertyAssociation hp = ct.propertyList().get(1);
