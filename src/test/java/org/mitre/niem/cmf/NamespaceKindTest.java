...
public class NamespaceKindTest {
    ...
    public void testNIEM5() {
        ...
        assertEquals(NIEM_NOTUTILITY, NamespaceKind.builtin("http://example.com/foo"));
        assertEquals(NIEM_NOTUTILITY, NamespaceKind.builtin("http://example.com/foo/5.0/#"));
        assertEquals(NIEM_NOTUTILITY, NamespaceKind.builtin(XML_NS_URI));
        assertEquals(NIEM_NOTUTILITY, NamespaceKind.builtin(W3C_XML_SCHEMA_NS_URI));
        assertEquals(NIEM_NOTUTILITY, NamespaceKind.builtin("http://release.niem.gov/niem/niem-core/5.0/"));
        assertEquals(NIEM_NOTUTILITY, NamespaceKind.builtin("http://release.niem.gov/niem/domains/humanServices/5.2/"));
        assertEquals(NIEM_NOTUTILITY, NamespaceKind.builtin("http://release.niem.gov/niem/auxiliary/cui/5.1/"));
        assertEquals(NIEM_NOTUTILITY, NamespaceKind.builtin("http://release.niem.gov/niem/codes/genc/5.0/"));         
    ...
    public void testNIEM6() {
        ...
        assertEquals(NIEM_NOTUTILITY, NamespaceKind.builtin("http://example.com/foo"));
        assertEquals(NIEM_NOTUTILITY, NamespaceKind.builtin("http://example.com/foo/6.0/#"));
        assertEquals(NIEM_NOTUTILITY, NamespaceKind.builtin(XML_NS_URI));
        assertEquals(NIEM_NOTUTILITY, NamespaceKind.builtin(W3C_XML_SCHEMA_NS_URI));
        assertEquals(NIEM_NOTUTILITY, NamespaceKind.builtin("https://docs.oasis-open.org/niemopen/ns/model/niem-core/6.0/#"));
        assertEquals(NIEM_NOTUTILITY, NamespaceKind.builtin("https://docs.oasis-open.org/niemopen/ns/model/domains/humanServices/6.0/#"));
        assertEquals(NIEM_NOTUTILITY, NamespaceKind.builtin("https://docs.oasis-open.org/niemopen/ns/model/cui/5.1/#"));
        assertEquals(NIEM_NOTUTILITY, NamespaceKind.builtin("https://docs.oasis-open.org/niemopen/ns/model/codes/genc/6.0/#"));         
        ...
        NamespaceKind.set("http://example.com/foo", "NIEM6", NSK_EXTENSION, NIEM_NOTUTILITY, "4");
