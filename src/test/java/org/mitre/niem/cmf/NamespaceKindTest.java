...
public class NamespaceKindTest {
    ...
    public void testNIEM5() {
        ...
        assertEquals(NSK_BUILTIN, NamespaceKind.kind("http://release.niem.gov/niem/appinfo/5.0/"));   
        ...
        assertEquals(NSK_BUILTIN, NamespaceKind.kind("http://reference.niem.gov/niem/specification/code-lists/5.0/code-lists-schema-appinfo/"));    
        assertEquals(NSK_BUILTIN, NamespaceKind.kind("http://release.niem.gov/niem/conformanceTargets/3.0/"));
        assertEquals(NSK_BUILTIN, NamespaceKind.kind("http://release.niem.gov/niem/proxy/niem-xs/5.0/"));
        assertEquals(NSK_BUILTIN, NamespaceKind.kind("http://release.niem.gov/niem/structures/5.0/")); 
    ...
    public void testNIEM6() {
        ...
        assertEquals("NIEM6", NamespaceKind.architecture("https://docs.oasis-open.org/niemopen/ns/specification/code-lists/6.0/instance/"));   
        assertEquals("NIEM6", NamespaceKind.architecture("https://docs.oasis-open.org/niemopen/ns/specification/code-lists/6.0/appinfo/")); 
        ...
        assertEquals(NIEM_CLI, NamespaceKind.builtin("https://docs.oasis-open.org/niemopen/ns/specification/code-lists/6.0/instance/"));   
        assertEquals(NIEM_CLSA, NamespaceKind.builtin("https://docs.oasis-open.org/niemopen/ns/specification/code-lists/6.0/appinfo/"));    
        ...
        assertEquals(NSK_BUILTIN, NamespaceKind.kind("https://docs.oasis-open.org/niemopen/ns/model/appinfo/6.0/"));   
        assertEquals(NSK_OTHERNIEM, NamespaceKind.kind("https://docs.oasis-open.org/niemopen/ns/specification/code-lists/6.0/instance/"));   
        assertEquals(NSK_BUILTIN, NamespaceKind.kind("https://docs.oasis-open.org/niemopen/ns/specification/code-lists/6.0/appinfo/"));    
        assertEquals(NSK_BUILTIN, NamespaceKind.kind("https://docs.oasis-open.org/niemopen/ns/specification/conformanceTargets/6.0/"));
        assertEquals(NSK_BUILTIN, NamespaceKind.kind("https://docs.oasis-open.org/niemopen/ns/model/adapters/niem-xs/6.0/"));
        assertEquals(NSK_BUILTIN, NamespaceKind.kind("https://docs.oasis-open.org/niemopen/ns/model/structures/6.0/")); 
        ...
        assertEquals("", NamespaceKind.version("https://docs.oasis-open.org/niemopen/ns/model/cui/6.0/"));
        ...
        assertEquals("6", NamespaceKind.version("https://docs.oasis-open.org/niemopen/ns/specification/code-lists/6.0/instance/"));   
        assertEquals("6", NamespaceKind.version("https://docs.oasis-open.org/niemopen/ns/specification/code-lists/6.0/appinfo/"));    
