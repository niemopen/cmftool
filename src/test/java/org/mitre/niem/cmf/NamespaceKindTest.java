...
public class NamespaceKindTest {
    ...
    public void testNIEM6() {
        ...
        assertEquals("", NamespaceKind.architecture(XML_NS_URI));
        assertEquals("", NamespaceKind.architecture(W3C_XML_SCHEMA_NS_URI));
        assertEquals("NIEM6", NamespaceKind.architecture("http://docs.oasis-open.org/niemopen/ns/model/niem-core/6.0/"));
        assertEquals("NIEM6", NamespaceKind.architecture("http://docs.oasis-open.org/niemopen/ns/model/domains/humanServices/6.0/"));
        assertEquals("NIEM6", NamespaceKind.architecture("http://docs.oasis-open.org/niemopen/ns/model/cui/5.1/"));
        assertEquals("NIEM6", NamespaceKind.architecture("http://docs.oasis-open.org/niemopen/ns/model/codes/genc/6.0/"));        
        assertEquals("NIEM6", NamespaceKind.architecture("http://docs.oasis-open.org/niemopen/ns/model/appinfo/6.0/"));   
        assertEquals("NIEM6", NamespaceKind.architecture("http://docs.oasis-open.org/niemopen/ns/specification/code-lists/6.0/code-lists-instance/"));   
        assertEquals("NIEM6", NamespaceKind.architecture("http://docs.oasis-open.org/niemopen/ns/specification/code-lists/6.0/code-lists-schema-appinfo/")); 
        assertEquals("NIEM6", NamespaceKind.architecture("http://docs.oasis-open.org/niemopen/ns/specification/conformanceTargets/3.0/"));
        assertEquals("NIEM6", NamespaceKind.architecture("http://docs.oasis-open.org/niemopen/ns/model/proxy/niem-xs/6.0/"));
        assertEquals("NIEM6", NamespaceKind.architecture("http://docs.oasis-open.org/niemopen/ns/model/structures/6.0/"));   
        
        assertEquals(NIEM_NOTBUILTIN, NamespaceKind.builtin("http://example.com/foo"));
        assertEquals(NIEM_NOTBUILTIN, NamespaceKind.builtin("http://example.com/foo/6.0/"));
        assertEquals(NIEM_NOTBUILTIN, NamespaceKind.builtin(XML_NS_URI));
        assertEquals(NIEM_NOTBUILTIN, NamespaceKind.builtin(W3C_XML_SCHEMA_NS_URI));
        assertEquals(NIEM_NOTBUILTIN, NamespaceKind.builtin("http://docs.oasis-open.org/niemopen/ns/model/niem-core/6.0/"));
        assertEquals(NIEM_NOTBUILTIN, NamespaceKind.builtin("http://docs.oasis-open.org/niemopen/ns/model/domains/humanServices/6.0/"));
        assertEquals(NIEM_NOTBUILTIN, NamespaceKind.builtin("http://docs.oasis-open.org/niemopen/ns/model/cui/5.1/"));
        assertEquals(NIEM_NOTBUILTIN, NamespaceKind.builtin("http://docs.oasis-open.org/niemopen/ns/model/codes/genc/6.0/"));         
        assertEquals(NIEM_APPINFO, NamespaceKind.builtin("http://docs.oasis-open.org/niemopen/ns/model/appinfo/6.0/"));   
        assertEquals(NIEM_CLI, NamespaceKind.builtin("http://docs.oasis-open.org/niemopen/ns/specification/code-lists/6.0/code-lists-instance/"));   
        assertEquals(NIEM_CLSA, NamespaceKind.builtin("http://docs.oasis-open.org/niemopen/ns/specification/code-lists/6.0/code-lists-schema-appinfo/"));    
        assertEquals(NIEM_CTAS, NamespaceKind.builtin("http://docs.oasis-open.org/niemopen/ns/specification/conformanceTargets/3.0/"));
        assertEquals(NIEM_PROXY, NamespaceKind.builtin("http://docs.oasis-open.org/niemopen/ns/model/proxy/niem-xs/6.0/"));
        assertEquals(NIEM_STRUCTURES, NamespaceKind.builtin("http://docs.oasis-open.org/niemopen/ns/model/structures/6.0/")); 

        assertEquals(NSK_UNKNOWN, NamespaceKind.kind("http://example.com/foo"));
        assertEquals(NSK_UNKNOWN, NamespaceKind.kind("http://example.com/foo/6.0/"));
        assertEquals(NSK_XML, NamespaceKind.kind(XML_NS_URI));
        assertEquals(NSK_XSD, NamespaceKind.kind(W3C_XML_SCHEMA_NS_URI));
        assertEquals(NSK_CORE, NamespaceKind.kind("http://docs.oasis-open.org/niemopen/ns/model/niem-core/6.0/"));
        assertEquals(NSK_DOMAIN, NamespaceKind.kind("http://docs.oasis-open.org/niemopen/ns/model/domains/humanServices/6.0/"));
        assertEquals(NSK_OTHERNIEM, NamespaceKind.kind("http://docs.oasis-open.org/niemopen/ns/model/cui/5.1/"));
        assertEquals(NSK_OTHERNIEM, NamespaceKind.kind("http://docs.oasis-open.org/niemopen/ns/model/codes/genc/6.0/"));         
        assertEquals(NSK_UTILITY, NamespaceKind.kind("http://docs.oasis-open.org/niemopen/ns/model/appinfo/6.0/"));   
        assertEquals(NSK_OTHERNIEM, NamespaceKind.kind("http://docs.oasis-open.org/niemopen/ns/specification/code-lists/6.0/code-lists-instance/"));   
        assertEquals(NSK_UTILITY, NamespaceKind.kind("http://docs.oasis-open.org/niemopen/ns/specification/code-lists/6.0/code-lists-schema-appinfo/"));    
        assertEquals(NSK_UTILITY, NamespaceKind.kind("http://docs.oasis-open.org/niemopen/ns/specification/conformanceTargets/3.0/"));
        assertEquals(NSK_UTILITY, NamespaceKind.kind("http://docs.oasis-open.org/niemopen/ns/model/proxy/niem-xs/6.0/"));
        assertEquals(NSK_UTILITY, NamespaceKind.kind("http://docs.oasis-open.org/niemopen/ns/model/structures/6.0/")); 
        
        assertEquals("", NamespaceKind.version("http://example.com/foo"));
        assertEquals("", NamespaceKind.version("http://example.com/foo/6.0/"));
        assertEquals("", NamespaceKind.version(XML_NS_URI));
        assertEquals("", NamespaceKind.version(W3C_XML_SCHEMA_NS_URI));
        assertEquals("", NamespaceKind.version("http://docs.oasis-open.org/niemopen/ns/model/niem-core/6.0/"));
        assertEquals("", NamespaceKind.version("http://docs.oasis-open.org/niemopen/ns/model/domains/humanServices/6.0/"));
        assertEquals("", NamespaceKind.version("http://docs.oasis-open.org/niemopen/ns/model/cui/5.1/"));
        assertEquals("", NamespaceKind.version("http://docs.oasis-open.org/niemopen/ns/model/codes/genc/6.0/"));        
        assertEquals("", NamespaceKind.version("http://release.niem.gov/niem/codes/genc/6.0/"));   
        assertEquals("6", NamespaceKind.version("http://docs.oasis-open.org/niemopen/ns/model/appinfo/6.0/"));   
        assertEquals("6", NamespaceKind.version("http://docs.oasis-open.org/niemopen/ns/specification/code-lists/6.0/code-lists-instance/"));   
        assertEquals("6", NamespaceKind.version("http://docs.oasis-open.org/niemopen/ns/specification/code-lists/6.0/code-lists-schema-appinfo/"));    
        assertEquals("", NamespaceKind.version("http://docs.oasis-open.org/niemopen/ns/specification/conformanceTargets/3.0/"));
        assertEquals("6", NamespaceKind.version("http://docs.oasis-open.org/niemopen/ns/model/proxy/niem-xs/6.0/"));
        assertEquals("6", NamespaceKind.version("http://docs.oasis-open.org/niemopen/ns/model/structures/6.0/"));
